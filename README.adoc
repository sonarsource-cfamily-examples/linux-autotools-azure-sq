...
// URIs:
:uri-qg-status: https://next.sonarqube.com/sonarqube/dashboard?id=sonarsource-cfamily-examples_linux-autotools-azure-sq_AYAYsLkPMi_-8diYBjGA
:img-qg-status: https://next.sonarqube.com/sonarqube/api/project_badges/measure?project=sonarsource-cfamily-examples_linux-autotools-azure-sq_AYAYsLkPMi_-8diYBjGA&metric=alert_status&token=squ_a0683d6d23bc3fa8b93a6befc840c774511333cc
:uri-build-status: https://dev.azure.com/sonarsource-cfamily-examples/linux-autotools-azure-sq/_build/latest?definitionId=2
:img-build-status: https://dev.azure.com/sonarsource-cfamily-examples/linux-autotools-azure-sq/_apis/build/status/sonarsource-cfamily-examples.linux-autotools-azure-sq

image:{img-build-status}[Build Status, link={uri-build-status}]
image:{img-qg-status}[Quality Gate Status,link={uri-qg-status}]

*This project is analysed on https://next.sonarqube.com/sonarqube/dashboard?id=sonarsource-cfamily-examples_linux-autotools-azure-sq_AYAYsLkPMi_-8diYBjGA[SonarQube]!*
